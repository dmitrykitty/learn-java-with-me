 ...
 */
public class MyLinkedListWithDummyNode {
    ...
    public MyLinkedListWithDummyNode() {
    ...
    public void addAtIndex(int index, int val) {
        ...
        Node curPred = dummyHead;

        for(int i = 0; i < index; i++){
            curPred = curPred.next;
        }

        Node temp = curPred.next;
        curPred.next = new Node(val, temp);
    }
    ...
    public void deleteAtIndex(int index) {
        ...
        Node toDelete = curPred.next;
        curPred.next = toDelete.next;
        toDelete.next = null;
    }
}
