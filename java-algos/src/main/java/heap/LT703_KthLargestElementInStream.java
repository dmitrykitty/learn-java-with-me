 ...
 * submit their scores. You are tasked to implement a class which, for a given integer k, maintains a stream of
 * test scores and continuously returns the kth highest test score after a new score has been submitted.
 ...
 * kthLargest.add(9); // return 8
 */
public class LT703_KthLargestElementInStream {
    private final Queue<Integer> minHeap;
    private final int size;

    public LT703_KthLargestElementInStream(int k, int[] nums) {
        size = k;
