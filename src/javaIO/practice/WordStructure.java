...
public class WordStructure {
     ...
     */
    public static void printAllWordsStatsWithVowel(Path path) throws IOException {
     ...
     */
    public static void printWordsEndsWithFirstLetterNextWord(Path path) throws IOException {
        try (Scanner scanner = new Scanner(path)) {
            if(!scanner.hasNext()){
                return;
            }
