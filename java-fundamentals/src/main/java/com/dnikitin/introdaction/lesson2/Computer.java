package com.dnikitin.introdaction.lesson2;

public class Computer { //PUBLIC DOSTĘPNY WE WSZYSTKICH PAKIETACH (dla klas tylko public lub package private)
    private static final int SECONDS_IN_MINUTE = 60; //const zaznaczane final i zawsze static
    private static final int MINUTES_IN_HOUR = 60;

    private int ssd = 500;
    private int ram = 8;
    private MotherBoard mb;
    private static int count = 0; //static nalezy nie do obiektu, a do całej klasy
